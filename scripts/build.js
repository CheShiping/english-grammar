...
function renderTopbar(levelLabel, baseHome) {
  ...
  <div class="site-topbar-inner">
    ...
    <div class="site-searchbox" role="search">⌕&nbsp;&nbsp;搜索课程…&nbsp;&nbsp;<kbd>Ctrl K</kbd></div>${levelLabel === null ? `<a class="site-guide-btn" href="${GUIDE_20LINK}" rel="noopener" title="打开《专升本英语语法 20 讲》"><span class="icon">${ICON_20BOOK}</span><span class="label">专升本 20 讲</span></a>` : ""}
