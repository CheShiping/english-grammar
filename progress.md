...
**站点 V5 · 已部署到 GitHub Pages（main 分支 / root）。** 65 课（零基础 5 + 基础 60）桌面/移动、暗色/亮色、动画/减动效全部跑通。
...
### 2026-09-16（会话 5：新增基础 G40–G57 同步首页）
- 用户放入基础 40–57 共 18 课，要求增量更新
- `bash init.sh` 跑通：build 65 课（零基础 5 + 基础 60），烟雾测试通过，源 HTML 未触碰
- 验证：新页含顶栏/侧栏/prev-next/CSS/当前课高亮；首页只列卡片
- 提交推送：`fbcf3d4`（84 文件，+22828/-100），main → GitHub Pages 自动部署
